...
const paginaNumeri: number[] = [ ...Array(5)].map((_, i) => i + 1 ) 
    ...
    <div class="flex flex-col items-center justify-center gap-8 w-full max-w-[1400px] my-8">
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-8 mx-auto">
                <Card class="cursor-pointer w-[220px] h-[248px] hover:bg-[#ee3133] hover:text-white transition-all"
                 v-for="character in listaSimpsons">
                    ...
                    >
                        ...
                        class="w-48 h-42 object-cover object-top mt-2 bg-amber-300 rounded-t-md border border-black">
